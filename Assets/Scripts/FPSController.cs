...
public class FPSController : MonoBehaviour
{
    ...
    [HideInInspector] public float sensitivityXMult = 1;
    [HideInInspector] public float sensitivityYMult = 1;
    ...
    [HideInInspector] public Vector3 rotationDif;
    [HideInInspector] public Vector3 positionDif;
    ...
    void FixedUpdate()
    {
        ...
        FPSCamera.gameObject.transform.localPosition = Vector3.Lerp(FPSCamera.gameObject.transform.localPosition,
            localCameraPositionTemp + new Vector3(swayX, swayY, 0), Time.deltaTime * 3);
        FPSCamera.gameObject.transform.localRotation = Quaternion.Lerp(FPSCamera.gameObject.transform.localRotation,
            Quaternion.Euler(localCameraRotationTemp.eulerAngles + localCameraRotationOffset), Time.deltaTime * 3);
    }
